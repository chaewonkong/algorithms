"""Self Number in Python

from BaekJoon Online Judge No.4673
...
def self_number(limit):
	"""Return list of numbers below limit 
	consist of sum of n and digits of n"""
...
if __name__ == '__main__':
	for number in self_number(10000):
		print(number)