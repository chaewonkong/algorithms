...
즉, 임의의 3의 배수 자연수 n이 주어졌을 때, 
해당 수를 3의 배수의 자연수 3개로 분리하는 방법의 개수를 출력해라. 
...
def solution(n):
    """return number of ways to split n into various multiples of 3"""

    if n < 9:
        return 0
    k = n // 3

    return sum([i for i in range(3, k+1)]) - 2*(k-2)
