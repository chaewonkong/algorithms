...
from CodeWars
URL: https://www.codewars.com/kata/53f40dff5f9d31b813000774/train/python
...
other than that they are valid triplets and that they contain sufficient information 
to deduce the original string. In particular, 
this means that the secret string will never contain letters 
